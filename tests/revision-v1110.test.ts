...
assert(backend.includes("delete data.kondisi") && backend.includes("version: '1.1.10-secure'"), "backend update legacy harus mempertahankan kondisi kosong dan melaporkan versi baru");
