...
assert(backend.includes("delete data.kondisi") && backend.includes("version: '1.1.14-production'"), "backend update legacy harus mempertahankan kondisi kosong dan melaporkan versi terbaru");
