...
assert(backend.includes("delete data.kondisi") && backend.includes("version: '1.1.11-secure'"), "backend update legacy harus mempertahankan kondisi kosong dan melaporkan versi terbaru");
