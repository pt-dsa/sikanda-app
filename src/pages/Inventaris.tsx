      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <p className="text-base text-gray-600 dark:text-gray-400 max-w-md mx-auto leading-relaxed">
            Menu <strong className="text-gray-900 dark:text-white font-semibold">Inventaris</strong> ini akan dikembangkan pada <strong className="text-gray-900 dark:text-white font-semibold">SIKANDA V2</strong>. Silakan nantikan pembaruan kami selanjutnya.
          </p>
        </div>
      </motion.div>
    </div>
