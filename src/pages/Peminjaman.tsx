...
export default function Peminjaman() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-4 text-center">
      ...
      >
        <div className="absolute -top-24 -right-24 w-48 h-48 bg-teal-500/10 dark:bg-teal-500/5 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-cyan-500/10 dark:bg-cyan-500/5 rounded-full blur-3xl"></div>
        
        <div className="relative z-10 flex flex-col items-center">
          <div className="w-20 h-20 bg-teal-100 dark:bg-teal-900/30 rounded-2xl flex items-center justify-center mb-6 shadow-inner">
          ...
          <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900 dark:text-white mb-3 tracking-tight">
            Menu Peminjaman dalam Pengembangan
          </h1>
          
          <p className="text-base text-gray-600 dark:text-gray-400 max-w-md mx-auto leading-relaxed">
            Menu Peminjaman dalam pengembangan, nantikan pada SIKANDA Versi 2.
          </p>
        </div>
      </motion.div>
    </div>
